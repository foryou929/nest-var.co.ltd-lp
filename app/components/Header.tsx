...
const Header = () => {
    ...
    return (
        <header className="fixed left-0 top-0 z-40 w-full">
            ...
            <div className={`${isOpen ? "right-0" : "-right-[400px]"} fixed top-0 w-full max-w-[400px] h-full bg-black text-white px-[16px] md:px-[60px] py-[16px] transition-all duration-500`}>
